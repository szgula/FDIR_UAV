...
ax2 = nexttile;
hold on
plot(ax2, t, rad2deg(y(:,4)), '--', 'LineWidth', 1);
plot(ax2,t, rad2deg(x_state(:,4)));
legend('y: measurment','x: internal state');
...
ax3 = nexttile;
hold on
plot(ax3, t, y(:,2), '--', 'LineWidth', 1);
plot(ax3,t, x_state(:,2));
legend('y: measurment','x: internal state');
...
ax4 = nexttile;
hold on
plot(ax4, t, rad2deg(y(:,3)), '--', 'LineWidth', 1);
plot(ax4,t, rad2deg(x_state(:,3)));
legend('y: measurment','x: internal state');
